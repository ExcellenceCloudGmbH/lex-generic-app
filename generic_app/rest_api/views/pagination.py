...
class CustomPageNumberPagination(PageNumberPagination):
    ...
    page_size_query_param : str
        The name of the query parameter that allows the client to set the page size.
    """
...
class CustomLimitOffsetPagination(LimitOffsetPagination):
    ...
    limit_query_param : str
        The name of the query parameter that allows the client to set the limit.
    offset_query_param : str
        The name of the query parameter that allows the client to set the offset.
    """
