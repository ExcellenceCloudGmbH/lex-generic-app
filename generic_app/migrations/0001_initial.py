...
import generic_app.rest_api.models.fields.XLSX_field
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logfile', generic_app.rest_api.models.fields.XLSX_field.XLSXField(default='', max_length=300, upload_to='')),
                ('input_validation', generic_app.rest_api.models.fields.XLSX_field.XLSXField(default='', max_length=300, upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='UserChangeLog',
